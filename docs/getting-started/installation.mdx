...
- **[ILSpy](https://github.com/icsharpcode/ILSpy/releases/latest)** - a .NET assembly viewer. (Any other IL viewer works too, but ILSpy is highly recommended for beginners.)
- **C# IDE** - the Integrated Development Environment (IDE for short) that you'll be working in. Most common free ones:
  - [Rider by Jetbrains](https://www.jetbrains.com/rider/) - free for non-commercial use. A bit better than Visual Studio.
  - [Visual Studio Community Edition by Microsoft](https://visualstudio.microsoft.com/vs/community/) - free unless you're corporation.
