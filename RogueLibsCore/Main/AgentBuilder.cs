...
namespace RogueLibsCore
{
    ...
    public class AgentBuilder
    {
        ...
        public AgentBuilder WithBodySprite(byte[] rawData)
        {
            ...
            {
                RogueLibs.CreateCustomSprite(MetaData.Name + "N", SpriteScope.Bodies, rawData, Area(1, 0), 64f),
                RogueLibs.CreateCustomSprite(MetaData.Name + "NE", SpriteScope.Bodies, rawData, Area(2, 0), 64f),
                RogueLibs.CreateCustomSprite(MetaData.Name + "E", SpriteScope.Bodies, rawData, Area(2, 1), 64f),
                RogueLibs.CreateCustomSprite(MetaData.Name + "SE", SpriteScope.Bodies, rawData, Area(2, 2), 64f),
                RogueLibs.CreateCustomSprite(MetaData.Name + "S", SpriteScope.Bodies, rawData, Area(1, 2), 64f),
                RogueLibs.CreateCustomSprite(MetaData.Name + "SW", SpriteScope.Bodies, rawData, Area(0, 2), 64f),
