...
namespace RogueLibsCore
{
    ...
    public sealed class CustomAgentMetadata
    {
        ...
        internal RogueSprite[]? _headSprite;
        internal RogueSprite[]? _bodySprite;
        ...
        public RogueSprite[]? GetHeadSprites() => _headSprite;
        ...
        public RogueSprite[]? GetBodySprites() => _bodySprite;





        private static readonly Dictionary<Type, CustomAgentMetadata> _infos = [];
        ...
        public static CustomAgentMetadata Get(Type type) => _infos.TryGetValue(type, out CustomAgentMetadata info) ? info : _infos[type] = new CustomAgentMetadata(type);
        ...
        private CustomAgentMetadata(Type type)
        {
            ...
            var categories = type.GetCustomAttributes<AgentCategoriesAttribute>()
